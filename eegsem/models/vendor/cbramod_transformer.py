"""Vendored from https://github.com/wjq-learning/CBraMod (MIT License, Jiquan Wang et al., ICLR 2025)."""
...
class TransformerEncoder(nn.Module):
    def __init__(
        self, encoder_layer, num_layers, norm=None, enable_nested_tensor=True, mask_check=True
    ):
        super().__init__()
